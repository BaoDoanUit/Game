...
int Game::InitWindow(int nCmdShow)
{
	...
	int windowStyle;
	if (G_IsFullScreen){
		windowStyle = WS_EX_TOPMOST | WS_VISIBLE | WS_POPUP; // fullscreen
	}
	else
	{
...
void Game::ProcessKeyboard()
{
	...
	//Scan through all data, check if the key is press or released
...
{
	return (_KeyStates[KeyCode] & 0 & 80) > 0;
}
